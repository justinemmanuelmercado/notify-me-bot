import { DiscordController as DiscordControllerInterface } from './interfaces/DiscordController'
import { Guild, Client, GuildChannel, TextChannel } from 'discord.js'
import { Notification } from './interfaces/Notification'
import { Channel } from './interfaces/Channel'

export class DiscordController implements DiscordControllerInterface {
  ...
  static async build() {
    try {
      ...
      return new DiscordController(client, guild!)
    } catch {
